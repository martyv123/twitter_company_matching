...
def author_brand_match():
    ...
    Writes to a temporary file called `authors_2_brand_tmp.csv'.
    """
    ...
    with open('authors_2_brand.csv', mode='r', encoding='utf-8-sig') as csv_file:
        csv_reader = csv.DictReader(csv_file)
        count = 0
        for row in csv_reader:
            count += 1
    ...
    # Write to tmp file authors_2_brand_tmp.csv
    with open('authors_2_brand_tmp.csv', mode='w', encoding='utf-8-sig', newline='') as csv_file:
